...
class Day11Test {
    public static final String DAY = "main/day11";
...
// inspection didn't damage the item causes your worry level to be divided by three and rounded down
// to the nearest longeger.
//
...
// the two most active monkeys if you want any hope of getting your stuff back.
...
// stuff-slinging simian shenanigans?
    @Test
    void shouldReturnMonkeyBusiness_example1_part1(){
        long monkeyBusinessLevel = day.part1(example1);

        assertThat(monkeyBusinessLevel).isEqualTo(10605);
    }

    @Test
    void shouldReturnTailsPositionsNumber_input_part1(){
        long monkeyBusinessLevel = day.part1(input);

        assertThat(monkeyBusinessLevel).isEqualTo(113220);
    }
...
@Test
void shouldReturnMonkeyBusiness_example1_part2(){
    long monkeyBusinessLevel = day.part2(example1);

    assertThat(monkeyBusinessLevel).isEqualTo(2713310158L);
}

    @Test
    void shouldReturnMonkeyBusiness_input_part2(){
        long monkeyBusinessLevel = day.part2(input);

        assertThat(monkeyBusinessLevel).isEqualTo(30599555965L);
    }
}
