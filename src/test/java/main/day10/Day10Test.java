...
class Day10Test {
    public static final String DAY = "main/day10";
...
// both driven by a precise clock circuit. The clock circuit ticks at a constant rate;
...
//Find the signal strength during the 20th, 60th, 100th, 140th, 180th, and 220th cycles. What is the sum of these six signal strengths?
    ...
    @Test
    void shouldReturnSignalStrengthsSum_example1_part1(){
        int sum = day.part1(example1);
    ...
    void shouldReturnTailsPositionsNumber_input_part1(){
        ...
        assertThat(number).isEqualTo(15260);
    }
...
// here are the cycles during which the first and last pixel in each
// row are drawn:
//
//Cycle   1 -> ######################################## <- Cycle  40
//Cycle  41 -> ######################################## <- Cycle  80
...
//Render the image given by your program. What eight capital letters appear on your CRT?
    @Test
    void shouldReturnLetters_example1_part2(){
        day.part2(example1);
    }

    @Test
    void shouldReturnLetters_input_part2(){
        day.part2(input);
    }
