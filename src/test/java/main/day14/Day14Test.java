...
class Day14Test {
    public static final String DAY = "main/day14";
...
// it's coming from the waterfall itself, and that doesn't make any sense.
...
// form the shape of the path, where x represents distance to the right and y represents distance down.
...
// (Specifically, the first path consists of a line of rock from 498,4 through 498,6 and another line
...
// the previous unit of sand comes to rest. A unit of sand is large enough to fill one tile of air
// in your scan.
//
...
// and to the right. Sand keeps moving as long as it is able to do so,
...
// flowing into the abyss below?
    ...
    @Test
    void shouldReturnSum_example1_part1() throws Exception {
    ...
    @Test
    void shouldReturnResult_input_part1() throws Exception {
        long rsult = day.part1(input);

        assertThat(rsult).isEqualTo(614);
    }

    @Test
    void shouldReturnResult_example1_part2() {
        int rsult = day.part2(example1);

        assertThat(rsult).isEqualTo(93);
    }

    @Test
    void shouldReturnResult_input_part2() {
        int rsult = day.part2(input);

        assertThat(rsult).isEqualTo(26170);
    }
}