...
class Day15Test {
    public static final String DAY = "main/day15";
...
// There could still be beacons that just happen to not be the closest beacon to any
...
// just in the row where y=10, you'd like to count the number of positions a beacon
// cannot possibly exist. The coverage from all sensors near that row looks like this:
//
//                 1    1    2    2
//       0    5    0    5    0    5
// 9 ...#########################...
...
//Consult the report from the sensors you just deployed. In the row where y=2000000, how many positions cannot contain a beacon?
    ...
    void shouldReturnResult_example1_part1() {
        long sum = day.part1(example1, 10);
    ...
    void shouldReturnResult_input_part1() {
        long rsult = day.part1(input, 2000000);

        assertThat(rsult).isEqualTo(4424278L);
    }
