...
class Day16Test {
    public static final String DAY = "main/day16";
...
// just like the one the Elves gave you. However, you don't see any Elves around;
// instead, the device is surrounded by elephants!
// They must have gotten lost in these tunnels, and one of the elephants apparently figured out how to turn
// on the distress signal.
//
//The ground rumbles again, much stronger this time. What kind of cave is this, exactly?
// You scan the cave with your handheld device; it reports mostly igneous rock, some ash, pockets of pressurized gas, magma...
// this isn't just a cave, it's a volcano!
//
//You need to get the elephants out of here, quickly. Your device estimates that you have 30 minutes before
...
// You estimate it will take you one minute to open a single valve and one minute to follow any tunnel from
...
// Then, you could spend your third minute moving to valve CC and your fourth minute
...
//
//Making your way through the tunnels like this, you could probably open many or all of the valves by the
// time 30 minutes have elapsed. However, you need to release as much pressure as possible,
...
//Work out the steps to release the most pressure in 30 minutes. What is the most pressure you can release?
    @Test
    void shouldReturnResult_example1_part1() {
        long sum = day.part1(example1);

        assertThat(sum).isEqualTo(1651);
    }

    @Test
    void shouldReturnResult_input_part1() {
        long rsult = day.part1(input);

        assertThat(rsult).isEqualTo(1148);
    }

    @Test
    void shouldReturnResult_example1_part2() {
        long rsult = day.part2(example1);

        assertThat(rsult).isEqualTo(56000011);
    }

    @Test
    void shouldReturnResult_input_part2() {
        long rsult = day.part2(input);

        assertThat(rsult).isEqualTo(10382630753392L);
    }
}