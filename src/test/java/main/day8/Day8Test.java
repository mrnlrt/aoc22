...
class Day8Test {
    public static final String DAY = "main/day8";
...
//35390
//
//Each tree is represented as a single digit whose value is its height, where 0 is the shortest and 9 is
// the tallest.
//
...
//Consider your map; how many trees are visible from outside the grid?
    ...
    @Test
    void shouldReturnVisibleTrees_example1_part1(){
        int visibleTrees = day.part1(example1);

        assertThat(visibleTrees).isEqualTo(21);
    }

    @Test
    void shouldReturnVisibleTrees_input_part1(){
        int visibleTrees = day.part1(input);

        assertThat(visibleTrees).isEqualTo(1825);
    }
...
// stop if you reach an edge or at the first tree that is the same height or taller than the
...
//Consider each tree on your map. What is the highest scenic score possible for any tree?
    @Test
    void shouldReturnScore_example1_part2(){
        int score = day.part2(example1);

        assertThat(score).isEqualTo(8);
    }

    @Test
    void shouldReturnScore_input_part2(){
        int score = day.part2(input);

        assertThat(score).isEqualTo(235200);
    }
