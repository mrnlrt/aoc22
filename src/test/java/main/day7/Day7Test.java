...
class Day7Test {
    public static final String DAY = "main/day7";
...
// moving into or out of directories and listing the contents of the directory
// you're currently in.
//
...
// What is the sum of the total sizes of those directories?
    @Test
    void shouldReturnSize_example1_part1(){
        double size = day.part1(example1);

        assertThat(size).isEqualTo(95437);
    }

    @Test
    void shouldReturnSize_input_part1(){
        double size = day.part1(input);

        assertThat(size).isEqualTo(1350966);
    }
...
// (and thus the total amount of used space) is 48 381 165;
// this means that the size of the unused space must currently be 21 618 835,
// which isn't quite the 30 000 000 required by the update.
// Therefore, the update still requires a directory with total size of at least 8 381 165
...
// to run the update. What is the total size of that directory?
    @Test
    void shouldReturnSize_example1_part2(){
        double size = day.part2(example1);

        assertThat(size).isEqualTo(24933642);
    }

    @Test
    void shouldReturnSize_input_part2(){
        double size = day.part2(input);

        assertThat(size).isEqualTo(6296435);
    }
